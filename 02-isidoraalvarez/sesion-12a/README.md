...
También hicimos investigaciones de cómo podríamos usar transistores, analizamos el funcionamiento y cómo podríamos utilizarlos para controlar cargas mayores sin exigir  las salidas de los circuitos integrados. Esta solución fue considerada especialmente para poder  incorporar leds y ver como avanzan los pasos.
Al comparar ambos circuitos nos dimos cuenta que el CD4040 genera patrones más impredecibles y variados, mientras que el CD4015 produce una sensación de movimiento más ordenada y fácil de seguir visualmente con los leds, por esto mismo decidimos seguir desarrollando ambos circuitos.
